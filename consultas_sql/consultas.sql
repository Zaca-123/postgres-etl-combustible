-- SQLBook: Code
SELECT registro_seccional.descripcion AS registro_seccional_descripcion,
       automotor.automotor_anio_modelo,
       COUNT(*) AS cantidad
FROM transferencia
INNER JOIN registro_seccional ON automotor.registro_seccional_id = registro_seccional.id
GROUP BY registro_seccional.descripcion, automotor.automotor_anio_modelo;

-- SQLBook: Code
SELECT tipo_automotor.codigo AS automotor_tipo_codigo,
...
GROUP BY tipo_automotor.codigo, tipo_automotor.descripcion, automotor.modelo_descripcion;

-- SQLBook: Code
SELECT automotor.tramite_fecha,
       automotor.automotor_origen,
       COUNT(*) AS cantidad
FROM transferencia
GROUP BY automotor.tramite_fecha, automotor.automotor_origen
